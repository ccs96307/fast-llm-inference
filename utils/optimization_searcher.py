...
class LayerSkipStrategySearcher:
    ...
    def optimize_acceptance_rate(
        ...
        print(f"The best accept_rate: {study.best_value}")
    ...
    def optimize_speculative_speed(
        ...
        print(f"The best params: {study.best_params}")
        print(f"The best speed: {study.best_value}")
    ...
    def objective_speculative_speed(self, trial, num_hidden_layers: int):
        ...
        token_per_second = total_generated_tokens / spent_time

        print(f"attn_skip: {skip_attn_layers}, mlp_skip: {skip_mlp_layers}, tokens/sec: {token_per_second}")

        # Assume we want to maximize `token_per_second`
